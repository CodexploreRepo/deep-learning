...
| **[EMNIST (Extened MNIST)](https://keras.io/examples/vision/mnist_convnet/)**       |                                                 | a set of handwritten character digits derived from the NIST Special Database 19                                                                                                             | `emnist/letters`, `emnist/digits`                                                              |
